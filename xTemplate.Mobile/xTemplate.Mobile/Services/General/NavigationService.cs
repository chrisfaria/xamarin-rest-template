...
namespace xTemplate.Mobile.Services.General
{
    public class NavigationService : INavigationService
    {
        ...
        protected virtual async Task InternalNavigateToAsync(Type viewModelType, object parameter)
        {
            ...
            else if (CurrentApplication.MainPage is MainView)
            {
                ...
                if (mainPage.Detail is ExerciseNavigationPage navigationPage)
                {
                ...
                {
                    navigationPage = new ExerciseNavigationPage(page);
            ...
            {
                var navigationPage = CurrentApplication.MainPage as ExerciseNavigationPage;
                ...
                {
                    CurrentApplication.MainPage = new ExerciseNavigationPage(page);
                }
            }
